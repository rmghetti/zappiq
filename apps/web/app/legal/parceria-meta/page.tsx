...
/* ══════════════════════════════════════════════════════════════════════════
 * /legal/parceria-meta: V3.3 (Meta Business Partner)
 * --------------------------------------------------------------------------
 * V2-013 (histórico) criou esta página com foco em BSP 360Dialog. V3.2
 * migrou para WhatsApp Cloud API direto Meta (sem BSP). V3.3 (12/07/2026,
 * decisão do fundador) atualiza o status: a designação Meta Business Partner
 * foi obtida; falta apenas a formalização documental (certificado e
 * listagem no diretório oficial). Atualizar esta página assim que o
 * certificado/ID oficial estiver disponível.
 *
 * Mantém o espírito original: evitar publicidade enganosa e deixar claro
 * o status real da relação com a Meta.
 * ══════════════════════════════════════════════════════════════════════════ */
  ...
  return (
    <PublicLayout>
      <article className="prose prose-lg mx-auto max-w-3xl px-6 pb-24">
        ...
        <p>
          Nos apresentamos como <strong>Meta Business Partner</strong> porque a designação foi
          obtida junto à Meta. A formalização documental (certificado e listagem no diretório
          público de parceiros) está em andamento; esta página será atualizada com o ID oficial
          assim que estiver disponível. Somos <strong>cliente da Cloud API</strong>, com conta
          WABA ativa e número verificado.
        </p>
        ...
        <h2>4. Status de designação</h2>
        <p>
          A designação <strong>Meta Business Partner</strong> foi obtida. O processo de
          formalização documental segue em andamento, com base em volume de tráfego WABA
          agregado através da Cloud API e conformidade com a política de plataforma Meta.
        </p>
        <p>
          Enquanto a formalização não se completa, mantemos a comunicação pública também
          referenciando a integração <strong>&quot;via WhatsApp Business Cloud API oficial
          Meta&quot;</strong>. Assim que disponíveis, esta página será atualizada com o
          certificado/ID oficial, um link para o diretório público da Meta e a data de concessão.
        </p>
        <p>
          A designação <strong>Meta Tech Provider</strong> (categoria distinta, voltada a
          provedores de tecnologia) não é reivindicada nesta página.
        </p>
