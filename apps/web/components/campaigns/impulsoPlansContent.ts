...
export const ZAP_IMPULSO_INTRO = {
  ...
  paragraphs: [
    ...
    'Você descreve o objetivo em uma frase e a Iza monta a campanha inteira: público segmentado da sua base, mensagem na voz da marca, melhor horário, verba sugerida e estimativa de resultado. Você revisa, edita o texto se quiser e aprova.',
    'A diferença do Zap Impulso está em fechar o ciclo com o seu CRM: a venda que acontece na conversa volta para otimizar a mídia (anúncio → conversa → venda → verba), e a Iza aprende com o resultado real para vender mais. Tudo respeitando o consentimento de marketing (LGPD) e as políticas da Meta.',
  ],
  pillars: [
    ...
    { name: 'Autopiloto com governança', desc: 'A Iza opera dentro de metas, orçamento e limites que você define.' },
  ],
};
...
export const PLAN_CONTENT: Record<PlanKey, PlanContent> = {
  IMPULSO_START: {
    ...
    scenario: {
      ...
      text: 'O salão quer trazer de volta quem não remarca há 60 dias. No Start, a dona diz à Iza "reativar quem não volta há 2 meses com 15% no primeiro horário". A Iza monta o segmento a partir da base, escreve a mensagem, sugere disparar na terça de manhã e envia pelo WhatsApp. No Coach, ela acompanha quantas remarcaram e a Iza sugere o próximo passo.',
    },
  },
  IMPULSO_PRO: {
    key: 'IMPULSO_PRO',
    ...
    active: [
      ...
      'Auto-otimização: a Iza testa variações e concentra a verba na que mais vende.',
    ...
    scenario: {
      ...
      text: 'Um infoprodutor roda anúncio com botão "Enviar mensagem". O lead cai no WhatsApp, a Iza qualifica e conduz a venda; quando a venda entra no CRM, a Conversions API a devolve ao Meta, que passa a mirar quem COMPRA (não só quem clica), baixando o custo por venda. Em paralelo, a Iza testa três variações de copy e concentra a verba na que mais converte.',
    },
  },
  IMPULSO_SCALE: {
    key: 'IMPULSO_SCALE',
    ...
    active: [
      'Tudo do Pro.',
      'Iza Autopiloto com governança: a IA decide o que, quando e quanto operar dentro de metas, orçamento e limites que você define.',
    ...
    scenario: {
      ...
      text: 'Uma rede com 8 lojas investe em Meta e Google. No Scale, cada unidade tem seu número, a Iza roda em autopiloto respeitando as regras definidas, sobe as vendas de loja física (offline) para Meta e Google otimizarem, e consolida a atribuição de receita por canal e por unidade num só painel.',
    },
  },
};
...
export const PLAN_COMPARISON: CompareRow[] = [
  { label: 'Iza Estrategista + Studio + Coach', start: true, pro: true, scale: true },
  ...
  { label: 'Iza Autopiloto com governança', start: false, pro: false, scale: true },
