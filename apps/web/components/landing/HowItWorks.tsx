...
const STEPS = [
  {
    ...
    desc: 'Em 5 minutos, vincule seu número comercial à ZappIQ via Cloud API oficial Meta.',
    animation: 'qr',
  },
  {
    num: '02',
    ...
    desc: 'Suba FAQs, catálogos e políticas. O Pulse AI aprende seu negócio sem consultor.',
    animation: 'faq',
  },
  {
    num: '03',
    ...
    desc: 'Sua equipe atende no painel enquanto a IA cuida do resto 24/7.',
    animation: 'scale',
  },
];
