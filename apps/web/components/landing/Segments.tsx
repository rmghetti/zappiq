...
const SEGMENTS = [
  { icon: Heart, name: 'Saúde', desc: 'Agendamento na conversa e retomada de inativos', metric: 'Agenda no WhatsApp', color: 'bg-red-50 text-red-500',
    details: { problems: ['Pacientes faltam em consultas sem avisar', 'Recepcionista gasta horas confirmando agenda', 'Recall de pacientes inativos é manual e inconsistente'],
      solution: 'A IA consulta o horário livre e marca a consulta dentro da conversa, e as campanhas de reativação trazem de volta quem não retorna há meses.',
      results: ['Agenda marcada sem passar pela recepção', 'Paciente inativo reaberto por campanha', 'Recepcionista focada no atendimento presencial'] }},
  ...
  { icon: Dog, name: 'Pet Shop', desc: 'Agendamento de banho e tosa, vacinas', metric: '+45% agendamentos', color: 'bg-orange-50 text-orange-500',
    details: { problems: ['Clientes ligam para agendar e a linha está ocupada', 'Controle de vacinas e vermífugos é manual', 'Sem programa de fidelidade eficiente'],
      solution: 'Agendamento 24h pelo WhatsApp, campanhas de vacina e vermífugo disparadas por você, e ofertas segmentadas por histórico de compra.',
      results: ['45% mais agendamentos com IA 24h', 'Recall de vacinas com 90% de adesão', '3x mais vendas com ofertas personalizadas'] }},
  { icon: Scissors, name: 'Salão de Beleza', desc: 'Agendamento direto na conversa', metric: 'Agenda no WhatsApp', color: 'bg-pink-50 text-pink-500',
    details: { problems: ['Clientes marcam e não aparecem', 'Agenda confusa com conflitos de horário', 'Sem remarketing para clientes inativos'],
      solution: 'A IA consulta o horário livre e marca na agenda dentro da própria conversa, e as campanhas de reativação trazem de volta quem sumiu.',
      results: ['Cliente marca sozinho, a qualquer hora, sem ida e volta', 'O horário sai da conversa direto para a agenda', 'Campanhas de reativação para quem parou de vir'] }},
  ...
  { icon: Calculator, name: 'Contabilidade', desc: 'Coleta de documentos e comunicação', metric: '-60% atrasos', color: 'bg-cyan-50 text-cyan-500',
    details: { problems: ['Clientes atrasam envio de documentos fiscais', 'Dúvidas repetitivas sobre impostos e prazos', 'Comunicação com muitos clientes simultaneamente'],
      solution: 'Cobrança de documento vira tarefa com prazo para a equipe, FAQ inteligente sobre impostos e obrigações, e campanhas em massa sobre mudanças na legislação.',
  ...
  { icon: Brain, name: 'Psicologia', desc: 'Agendamento e acompanhamento na conversa', metric: 'Agenda no WhatsApp', color: 'bg-violet-50 text-violet-500',
    details: { problems: ['Pacientes faltam sem avisar e não reagendam', 'Dificuldade em manter acompanhamento entre sessões', 'Agenda manual gera conflitos'],
      solution: 'Agendamento 24h na própria conversa e mensagens de acompanhamento entre sessões, escritas e disparadas pelo profissional.',
      results: ['Sessão marcada fora do horário comercial', 'Contato entre sessões sem ocupar a agenda', 'Agenda digitalizada, sem conflito de horário'] }},
