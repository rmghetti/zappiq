...
export type FlowTemplateVertical = 'DENTISTA' | 'SALAO_BELEZA' | 'ACADEMIA' | 'PETSHOP' | 'ECOMMERCE_MODA' | 'PSICOLOGO' | 'ADVOGADO' | 'NUTRICIONISTA' | 'IMOBILIARIA' | 'RESTAURANTE' | 'ESCOLA' | 'SERVICOS_TECNICOS' | 'CLINICA_MEDICA' | 'CONTABILIDADE' | 'OFICINA' | 'AGENCIA_DIGITAL';
...
export const TEMPLATE_RICH_INFO: Record<string, TemplateRichInfo> = {
  ...
  'PSICOLOGO_BOAS_VINDAS_QUALIFICACAO': {
    shortPitch: 'Recebe lead novo, qualifica intencao e direciona pra proximo passo.',
    whatItDoes: ['Apresentacao calorosa', 'Pergunta o objetivo', 'Lead-scoring', 'Repasse pra equipe'],
    ...
    expectedMetrics: [{ label: 'Conversao 1a interacao', value: '~38%' }, { label: 'Tempo de qualificacao', value: '< 2min' }, { label: 'Leads qualificados/sem', value: '+24' }],
    complexity: 'BAIXA',
    estimatedSetupMinutes: 5,
  ...
  'PSICOLOGO_AGENDAMENTO_RECUPERACAO': {
    ...
    whatItDoes: ['Cron dispara apos prazo', 'Mensagem com proxima acao', 'Confirma intencao', 'Agenda/registra'],
    indicatedFor: 'Negocios que perdem leads na inercia depois do primeiro contato.',
    expectedMetrics: [{ label: 'Taxa de resgate', value: '~22%' }, { label: 'Conversao apos resgate', value: '~32%' }, { label: 'Receita incremental/mes', value: '+R$ 3-8k' }],
    complexity: 'BAIXA',
    estimatedSetupMinutes: 4,
    bestUseCase: 'Combine com boas-vindas pra fechar funil captacao -> resgate.',
  },
  'PSICOLOGO_NPS_POS_VENDA': {
    shortPitch: 'Coleta NPS pos-atendimento e direciona promotor pra review publica.',
    whatItDoes: ['Cron pos-servico', 'Pergunta nota 0-10', 'Promotor recebe link review', 'Detrator escala humano'],
    indicatedFor: 'Negocios construindo reputacao digital onde reviews fazem diferenca no fluxo organico.',
